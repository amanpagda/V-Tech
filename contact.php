  ...
  <div id="app">
    <div id="hero">
            ...
            <div class="contect_main" style="background-color:#06425e;height: 455px;">
              ...
              <div style="background-color:#f4f2f9;" class="fom_main">
                <form class="pt-4">
                  ...
                  <div class="row mt-3">
                    <div class="col">
                      <input type="tel" class="form-control py-3" id="phone" name="phone" placeholder="Phone"
                ...
                <form action="/action_pag.php">
                  <div class="mb-5 mt-3">
                    <textarea class="form-control" rows="5" placeholder="Write a message" id="comment"
                      name="text"></textarea>
                  </div>
      ...
      <div class="container-fluid">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14752.156311318477!2d70.062223!3d22.427554949999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1708346963954!5m2!1sen!2sin"
          width="100%" height="550" style=" border:0;padding-top:50px;" allowfullscreen="" loading="lazy"
