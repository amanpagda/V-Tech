                    ...
                    <div class="form-items">
                        ...
                        <form method="POST" action="index.php">
                            ...
                            <div class="form-button">
                                <button id="submit" type="submit" name="login_submit" class="ibtn">Login Now</button>
                            </div>
                        </form>
                        ...
                        <div class="forgot-btn">
                            <button type="button" class="btn btn-danger"><a href="reset_pass.php" class="text-white">Forgot Password</a></button>
                        </div>
                    </div>
                </div>
            </div>
